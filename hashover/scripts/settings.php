...
{
	// Required setup
	public    $notificationEmail	= 'ankurchaudhry.india@gmail.com';	// E-mail for notification of new comments
	protected $encryptionKey	= 'ankurchaudhry1234';			// Unique encryption key
	protected $adminName		= 'ankur';			// Login name to gain admin rights (case-sensitive)
	protected $adminPassword	= 'password1';			// Login password to gain admin rights (case-sensitive)
